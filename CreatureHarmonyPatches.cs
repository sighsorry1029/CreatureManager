...
internal static class CreatureManagerObjectDbAwakePatch
{
    ...
    private static void Postfix(ObjectDB __instance)
    {
        ...
        bool isFinalSerializedDatabase =
            __instance.GetComponent<FejdStartup>() == null &&
            __instance.m_items.Count > 0;
        CreatureDomainManager.NotifyGameDataAvailable(objectDbFinalized: isFinalSerializedDatabase);
    }
}
...
internal static class CreatureManagerObjectDbCopyOtherDbPatch
{
    ...
    private static void Postfix(ObjectDB __instance)
    {
        CreaturePrefabRegistry.RegisterPendingPrefabs(__instance);
        CreatureModifierManager.RegisterStatusEffects(__instance);
        CreatureDomainManager.NotifyGameDataAvailable(objectDbFinalized: true);
    }
}
...
internal static class CreatureKarmaMinimapHud
{
    ...
    internal static void Clear()
    {
        if (KarmaText != null)
        {
            UnityEngine.Object.Destroy(KarmaText.gameObject);
        }
...
internal static class CreatureManagerCharacterSetLevelPatch
{
    ...
    {
        __state = CreatureLevelManager.CaptureStoredHealthDeficit(__instance);
    }
    ...
    private static void Postfix(Character __instance, int level, float __state)
    {
        ...
        CreatureLevelManager.RestoreStoredHealthDeficit(__instance, __state);
        CreatureModifierManager.RefreshStoredReapingScale(__instance);
    }
}
